...
public class ReservaClient {
    ...
    public ReservaClient(WebClient.Builder webClientBuilder,
                         @Value("${reservas.service.url}") String reservasServiceUrl) {
        this.webClient = webClientBuilder.baseUrl(reservasServiceUrl).build();
    }

    public Mono<List<Map<String, Object>>> getReservasBySocio(int idSocio) {
    ...
    public List<Map<String, Object>> getReservasBySocioBlocking(int idSocio) {
