...
class PagoControllerTest {
    ...
    void setUp() {
        ...
        pagoFalso.setMedioPago("Efectivo");

        pagoDTO = new PagoDTO();
        pagoDTO.setId(1L);
        pagoDTO.setValorNeto(15000);
        pagoDTO.setMedioPago("Efectivo");
    }
    ...
    void debeCrearPago() throws Exception {
        when(pagoService.procesarYGuardarPago(any(Pago.class))).thenReturn(pagoFalso);
